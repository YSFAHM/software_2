export function addCard(cardData) {
    ...
    <div class="row g-0">
        ...
        <div class="card-body ps-0">
            <div class="row">
                <div class="col">
                    <h3 class="mb-0">${cardData.name}</h3>
                </div>
                <div class="col-auto fs-3 text-green">${cardData.service}</div>
            </div>
            <div class="row">
                <div class="col-md">
    ...
    const url = `companyProfile.html?id=${id}`;
